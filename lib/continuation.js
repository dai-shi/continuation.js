                        ...
                        var ff238 = function (err, data) {
                            ...
                            if (k233 instanceof CpsContinuation) {
                                ...
                                return new CpsFunction(function (kk237) {
                                    return module._compile.CpsEnabled ? module._compile(root.transform(root.parse(data)), filename, kk237) : module._compile(root.transform(root.parse(data)), filename);
                                }, k233);
                                return;
                            }
                            if (err)
                            ...
                            module._compile.CpsEnabled ? CpsRun(new CpsFunction(function (kk236) {
                                return module._compile(root.transform(root.parse(data)), filename, kk236);
                            }, new CpsContinuation())) : module._compile(root.transform(root.parse(data)), filename);
                        };
